...
<head>
  ...
  <!-- O navegador irá interpretar algumas letras específicas do alfabeto brasileiro -->
  <meta charset='UTF-8'>

  <!-- VIEWPORT -->
  <!-- Os sites se tornaram visualmente adaptado as telas dos celulares -->
  <meta name='viewport' content='width=device-width, initial-scale=1.0'>

  <!-- ROBOTS -->
  <!-- Tag específica para incluir seu projeto web nos motores de busca de internet  -->
